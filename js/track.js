...
var campaignID = "67ee8b806bdc5a8b75d2a096";
...
var initialSrc = "https://info.productsreviewinternational.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("info.productsreviewinternational.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://info.productsreviewinternational.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://info.productsreviewinternational.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
